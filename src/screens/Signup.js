...
export default function Signup () {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const response = await fetch("http://13.232.106.215/api/createuser", {
            method: 'POST',
            headers: {
            ...
            body:JSON.stringify({
                ...
                location:credentails.geolocation 
            })
        });
            ...
            <div className='container'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" name='geolocation' value={credentails.geolocation} onChange={onChange} id="exampleInputAddress1" />
                    </div>
